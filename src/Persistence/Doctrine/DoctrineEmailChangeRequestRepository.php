...
namespace Makraz\Bundle\VerifyEmailChange\Persistence\Doctrine;
...
/**
 * Doctrine ORM implementation of the email change request repository.
 *
 * This is the default persistence adapter and requires doctrine/orm.
 */
class DoctrineEmailChangeRequestRepository implements EmailChangeRequestRepositoryInterface
{
